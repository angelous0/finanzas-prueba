              ...
              <div className="modal-content" style={{ maxWidth: '700px' }} onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-body">
                  ...
                  <div style={{ marginBottom: '1rem' }}>
                    <label style={{ fontSize: '0.75rem', fontWeight: 500, color: '#64748b', display: 'block', marginBottom: '6px' }}>Método de prorrateo</label>
                  ...
                  {metodo === 'ventas_rango' && (
                    <div style={{ display: 'flex', gap: '0.5rem', alignItems: 'flex-end', marginBottom: '1rem' }}>
                      <div>
                        <label style={{ fontSize: '0.75rem', color: '#64748b', display: 'block', marginBottom: '4px' }}>Desde</label>
                      ...
                      <div>
                        <label style={{ fontSize: '0.75rem', color: '#64748b', display: 'block', marginBottom: '4px' }}>Hasta</label>
                  ...
                  {/* Preview results */}
                  {previewLoading ? (
                    <p style={{ textAlign: 'center', color: '#94a3b8', padding: '1rem' }}>Calculando...</p>
  ...
  return (
    <>
      ...
      {expanded && item.detalle?.length > 0 && (
        <tr>
          <td colSpan={6} style={{ padding: '0.5rem 2rem', background: '#f8fafc' }}>
