                ...
                <tbody>
                  {marcas.map(m => (
                    <tr key={m.id}>
                      ...
                      <td>{m.codigo || '-'}</td>
                      <td style={{ color: '#6b7280', fontSize: '0.875rem' }}>{m.odoo_marca_key || '-'}</td>
                      ...
                      <td className="text-center">
                        <div style={{ display: 'flex', gap: '0.25rem', justifyContent: 'center' }}>
                          ...
                          <button className="btn btn-outline btn-sm btn-icon" onClick={() => handleDelete(m.id)} title="Eliminar" style={{ color: '#dc2626' }}><Trash2 size={14} /></button>
                        </div>
                      </td>
                    </tr>
                  ))}
