        ...
        <div className="modal-body">
          ...
          <div style={{ background: '#f8fafc', padding: '1rem', borderRadius: '8px', marginBottom: '1.5rem', border: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontWeight: 600, color: '#1B4D3E', fontFamily: "'JetBrains Mono', monospace" }}>{formatCurrency(factura.saldo_pendiente)}</span>
            </div>
          </div>

          {/* Quick generation */}
          <div style={{ background: '#f0fdf4', padding: '1rem', borderRadius: '8px', marginBottom: '1.5rem', border: '1px solid #bbf7d0' }}>
            <h4 style={{ margin: '0 0 1rem', fontSize: '0.875rem', fontWeight: 600, color: '#166534' }}>Generacion Rapida</h4>
          ...
          <div style={{ marginBottom: '1rem' }}>
            <h4 style={{ margin: '0 0 0.75rem', fontSize: '0.875rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{ fontWeight: 400, fontSize: '0.75rem', color: '#64748b' }}>- Puedes editar montos y fechas antes de crear</span>
            </h4>
            <table className="data-table" style={{ fontSize: '0.8125rem' }}>
              ...
              <tfoot>
                <tr style={{ background: '#f8fafc', fontWeight: 600 }}>
                  ...
                  <td className="text-right" style={{ fontFamily: "'JetBrains Mono', monospace", color: mismatch ? '#EF4444' : '#1B4D3E' }}>
