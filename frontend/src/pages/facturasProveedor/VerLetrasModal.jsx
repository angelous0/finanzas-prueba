        ...
        <div className="modal-body">
          <div style={{ background: '#fef3c7', padding: '1rem', borderRadius: '8px', marginBottom: '1.5rem', border: '1px solid #fcd34d' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
              ...
              <span style={{ fontWeight: 600, fontFamily: "'JetBrains Mono', monospace", color: '#92400e' }}>{factura.numero}</span>
            </div>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
              ...
              <span style={{ fontWeight: 600, fontFamily: "'JetBrains Mono', monospace", color: '#92400e' }}>{formatCurrency(factura.total)}</span>
            </div>
          </div>
